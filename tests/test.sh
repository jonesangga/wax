...
# Source: https://stackoverflow.com/a/10118989
...
declare -a file_base=("declaration")

# Loop the array
for file in "${file_base[@]}"; do
    # Padd file_base with suffixes
    file_in="$file.wax"             # The in file
    file_out_tst="$file.c"          # The outfile from test application
    file_out_val="$file.test"       # The out file to check against
